#!/usr/bin/env node
/* CXOrbia V57 · Apply automations metadata in DEV. Requires explicit local confirmation. */
...
const REQUIRED = 'AUTORIZO_CARGAR_AUTOMATIONS_V57_FIRESTORE_DEV';
...
if(!input){
  console.error('Uso: node apply-automations-write-plan-dev.mjs <write-plan.json>');
  process.exit(2);
}

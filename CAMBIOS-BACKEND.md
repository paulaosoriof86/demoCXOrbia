...
Gate de Paula/lane PASS. STOP_RETRY en source preflight por `ERR_MODULE_NOT_FOUND` de Playwright. Fallo antes de tooling/provider credentials; no provider access ni identity modification.
...
- source patcher: materializa/verifica lineage en command provider antes de provider use;
- no provider retry.

Source lock: `app/docs/SOURCE-LOCK-ITERATION3-PREPROVIDER-SELFTEST-FAIL-CLOSED-20260814.md`.

## Seguridad run `31852717413`
...
Claude/prototipo: sin UI change.  

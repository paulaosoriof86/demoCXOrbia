...
CX.topbar = {
  ...
  _mails:null,
  mailStore(){ if(!this._mails)try{this._mails=JSON.parse(localStorage.getItem('cx_mails')||'null')||[{id:'m1',de:'cliente@marca.com',para:'equipo',asunto:'Consulta sobre el programa',cuerpo:'Hola, quería consultar sobre la próxima ronda de evaluaciones. ¿Cuándo empezamos?',fecha:'2026-06-23 09:12',leido:true,proyecto:'TyA · Cinépolis GT/HN'},{id:'m2',de:'shopper@gmail.com',para:'equipo',asunto:'Duda sobre mi visita agendada',cuerpo:'Buenos días, tengo una duda: ¿puedo cambiar la franja de mi visita del viernes? Me surgió un compromiso.',fecha:'2026-06-24 14:35',leido:false,proyecto:'TyA · Cinépolis GT/HN'},{id:'m3',de:'nuevo_cliente@empresa.com',para:'equipo',asunto:'Solicitud de información - programa de evaluaciones',cuerpo:'Hola, somos una cadena de 12 puntos de venta y nos interesa implementar mystery shopping. ¿Podría enviarnos información?',fecha:'2026-06-25 08:20',leido:false,proyecto:null}];}catch(e){this._mails=[];} return this._mails; },

...
CX.saasConsole = {
  ...
  seed(){
    return [
      {id:'tya', nombre:'TyA Consultores', plan:'Enterprise', pais:['GT','HN'], estado:'Activo', proyectos:3, usuarios:14, version:'V72', modulos:{dashboard:true,visitas:true,finanzas:true,crm:true,marketing:true,academia:true,portal:true}, flags:{iaGemini:true,evidenciaGeo:true,benchmark:false,facturacionFEL:false}},
      {id:'demo', nombre:'Consultora Demo', plan:'Estándar', pais:['GT'], estado:'Trial', proyectos:1, usuarios:3, version:'V72', modulos:{dashboard:true,visitas:true,finanzas:true,crm:true,marketing:false,academia:true,portal:true}, flags:{iaGemini:false,evidenciaGeo:false,benchmark:false,facturacionFEL:false}},
    ];
  },
    ...
    host.innerHTML=`
      ...
      <div class="card card-p">
        ...
        <table class="tbl"><thead><tr><th>Versión</th><th>Fecha</th><th>Alcance</th><th>Estado</th></tr></thead><tbody>
          <tr><td><b>V72</b></td><td>2026-07-03</td><td>HR Source gates · liquidaciones candidatas · consola SaaS</td><td><span class="bdg bdg-g">Publicado</span></td></tr>

...
CX.module('financiero', ({data,ui})=>{
  ...
  ${(()=>{ /* CORTE 3 P0-6 — bandeja visible de revisiones financieras fail-closed.
    ...
    return `<div class="card card-p" style="margin-bottom:16px;border-color:#f3d9d9">
      ...
      <div style="font-size:11.5px;color:var(--t2);margin-bottom:10px">Mientras la fuente esté incompleta no se permite pago, lote ni confirmación. Cada fila conserva su país y moneda. Contratos de revisión: reviewRequired, financialSourceStatus (pending_or_review), liquidationState (pending_financial_source), paymentState (pending_source_confirmation).</div>

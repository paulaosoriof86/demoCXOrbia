...
Private execution handoff source-only PASS: A/B/C exactos cifrados y memory-only; D determinístico; provider/Auth/Firestore writes0. M5 no suma todavía porque no hubo write/readback.
...
Cadena: `C6 STAFF REPAIR/BOOTSTRAP EXACT WRITE V2 AUTHORIZATION -> exact write/readback/rollback -> wiring -> M7 -> M8 -> M9 -> M10`.

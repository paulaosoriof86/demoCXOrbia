#!/usr/bin/env node
/* Verificador independiente del manifest Cloud V6 Core Operations + Shopper.
   Uso: ejecutar desde app/ con:
   node docs/verify-manifest-cloud-v6-20260804.mjs */
import { readFile } from 'node:fs/promises';
import { createHash } from 'node:crypto';
import path from 'node:path';

const ROOT = process.cwd();
const MANIFEST_PATH = path.join(ROOT, 'docs', 'MANIFEST-CLOUD-V6-CORE-OPS-SHOPPER-20260804.json');

...
- Auth users: 17
- Colecciones raíz: 1
- Rutas de colección descubiertas: 83
...
| tenants/tya/projects | 29 | canAssignVisitsFromSource, canCreateShoppersFromSource, clientId, country, id, isPeriodSelectable, name, periodKey, source, sourceSheet, sourceType, status, sync, syncMode, tenantId |
...
| tenants/tya/shoppers | 215 | ciudad, code, email, estado, firstName, id, lastName, migratedFrom, nombre, pais, perfilCompleto, phone, rating, tenantId |

...
**Estado de write: MATERIALIZED + READBACK PASS. Estado técnico del consumidor: PASS. Estado del corte: VALIDACIÓN OPERATIVA/VISUAL PENDIENTE.**
...
No repetir materialización. No nueva base/candidata/rama/PR. No parche UI por rutina. El Hosting público final `tya-plataforma` todavía no se toca.

## 10. Corte 6 — Auth/RBAC
...
## 11. Corte 7 — sincronización/evidencias
...
## 12. Corte 8 — preproducción/cutover
...
## 13. Claude/prototipo
No nueva candidata. No reabrir V182. El P0 backend está técnicamente resuelto. Claude interviene solo si la validación visual posterior demuestra P0 frontend reproducible o por backlog P1/P2.

## 14. Academia
Actualizar manuales/cursos/rutas con: fuente viva vs snapshot, referencia HR vs perfil canónico, identidad operativa vs source-safe, proyecto padre vs periodo, readback vs consumidor runtime, materialización/readback y liquidación ≠ pago.

## 15. Estado seguro
R17N: 1,406 Firestore writes autorizados ya ejecutados. Corrección/re-smoke actual: provider reads únicamente; Firestore/Auth/Storage/HR/legacy writes=0; deletes=0; pagos/lotes=0; deploy=0; merge=false; producción=false; Make/Gemini=0; PII cruda repo/artifacts=0.

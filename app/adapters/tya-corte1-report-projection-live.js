...
window.CX = window.CX || {};
(function(){
  function buildProjection(snapshot,liveMeta){
    ...
    if(!valid){window.CX_TYA_CORTE1_REPORTS=null;window.CX_TYA_CORTE1_REPORTS_LIVE_META=null;return null;}
    ...
    const projection={
      ...
      sourceRevision:liveMeta?.revision||window.CX_TYA_HR_LIVE_META?.revision||null,
  ...
  window.CX_TYA_BUILD_CORTE1_REPORTS=buildProjection;
  buildProjection(window.CX_TYA_HR_SOURCE_SAFE||null,window.CX_TYA_HR_LIVE_META||null);
})();

...
if(lock.m3MechanismEpoch!==E||lock.m3ExecutionControl?.mechanismEpoch!==E||lock.m3ExecutionControl?.currentResidualHolds!==28)fail('lock_m3_state');
...
if(cert.m3MechanismEpoch!==E||cert.status!=='REPAIR_APPLIED_AWAITING_REMOTE_READBACK'||cert.certified!==false)fail('cert_pre_readback_state');
...
console.log('m3Status=REPAIR_APPLIED_CERTIFICATION_PENDING_READBACK');

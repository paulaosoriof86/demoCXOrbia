...
if(lock.rc15ControlPlaneEpoch!=='RC15-M2-F0-CLOSED-20260825-01')fail('m2_control_epoch');
...
if(m3.m3MechanismEpoch!=='RC15-M3-MECHANISM-20260825-01'||m3.status!=='ACTIVE_MECHANISM_CORRECTED_2_OF_30_TOMBSTONED')fail('m3_evidence');
...
for(const p of canonicalDocs){const t=readText(p);for(const marker of ['CXORBIA-MASTER-GO-LIVE-POSTPROD-RC15-V1','RC15-M3-MECHANISM-20260825-01','M3_F1_F2_INERTIZATION_CANONICAL_AUTHORITY','98/100'])if(!t.includes(marker))fail(`mirror_drift:${p}:${marker}`);}
...
console.log('m3Status=ACTIVE_2_OF_30_TOMBSTONED');

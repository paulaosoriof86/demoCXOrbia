...
const runtimeTool = path.join(here, `.cxorbia-c6-auth-plan-v4-activation-dev-v3-runtime-${process.pid}.mjs`);
...
try {
  ...
  if (process.argv.includes('--source-repair-self-test')) {
    console.log('PASS_C6_AUTH_PLAN_V4_HASH_CONFIG_RESPONSE_PATH_REPAIR_SOURCE_ONLY');
    process.exit(0);
  }

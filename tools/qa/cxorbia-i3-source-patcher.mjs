...
function patched(){
  ...
  if(!provider.includes("['cxorbia-i3-shopper-persistence-20260814-04','I3_PREPROVIDER_SOURCE_SELFTEST_PLAYWRIGHT_IMPORT_ORDER']")){
    const anchor="['cxorbia-i3-shopper-persistence-20260814-03','I3_HISTORICAL_NAV_TIMEOUT_BEFORE_LEGAL_GATE_AWARE_CHECKPOINT']\n  ];";

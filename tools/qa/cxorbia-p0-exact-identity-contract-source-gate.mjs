...
check('real_e2e_explicit_execution_gate',realExecution.includes('YES_SOURCE_APPROVED_REAL_READONLY_E2E')&&realExecution.includes('privateCredential()')&&realE2E.includes('PRIVATE_E2E_CREDENTIALS_REQUIRED'));

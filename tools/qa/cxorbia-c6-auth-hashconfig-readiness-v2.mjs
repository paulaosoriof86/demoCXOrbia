...
const fp = value => sha256(value).slice(0, 20);
...
async function main() {
  const report = {
    schemaVersion: 'cxorbia.c6.auth-hashconfig-readiness.v2',
  ...
  try {
    ...
    report.safety.providerReads += 1;
    report.safety.iamReads += 1;
    ...
    report.safety.providerReads += 1;
    report.safety.identityToolkitReads += 1;

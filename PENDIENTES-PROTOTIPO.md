...
Pendiente: `C6 STAFF TARGET PRIVATE IDENTITY RECOVERY SOURCE-ONLY -> recovery PASS -> nueva autorización exact-write -> repair/readback/rollback -> wiring -> M7 -> M8 -> M9 -> M10`.

No pedir owners/scopes/HR otra vez; no inferir B; no hardcode/wildcard; no nueva candidata/rama/PR/workflow; no writes hasta recovery PASS + autorización; no deletes/deploy/merge/producción.

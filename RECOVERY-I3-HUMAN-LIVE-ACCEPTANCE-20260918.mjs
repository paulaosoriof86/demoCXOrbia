...
const accepted=all,history=all.filter(x=>x.h>0&&x.co),acceptedHistory=history;if(!all.length)throw new Error('AUTH_FAILURE:NO_ACTIVE_SHOPPER');if(!history.length)throw new Error('MAPPING_FAILURE:NO_AUTH_SHOPPER_WITH_HR_HISTORY');
